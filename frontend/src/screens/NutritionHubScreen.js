        ...
        <View style={s.pageInner}>
          ...
          <View style={s.contentGrid}>
            ...
            <View style={[s.card, s.recommendationCard, SHADOWS.subtle]}>
              <Text style={s.cardTitle}>Diet recommendations</Text>
              <Text style={s.cardDesc}>Generated by backend rules when vitals and diagnosed conditions match.</Text>

              {recommendations.length === 0 ? (
                <View style={s.emptyBox}>
                  <Text style={s.emptyText}>No nutrition recommendation has been generated yet.</Text>
                </View>
              ) : (
